...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">@lang('main.add new portfolio')</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          ...
          <div class="card-body">
            <form method="post" action="{{route('portfolios.store')}}" enctype="multipart/form-data">
              ...
              <div class="form-group col-sm-6">
                ...
                <input type="url" name="url_link" value="{{old('url_link')}}" class="form-control" id="url_link" placeholder="@lang('main.enter url_link')">
              </div>
              <div class="form-group col-sm-6">
