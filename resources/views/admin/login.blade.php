...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="{{url('/storage/'.$settings->logo)}}">
...
<link href="https://fonts.googleapis.com/css2?family=Almarai:wght@300&display=swap" rel="stylesheet">
  <style type="text/css">
    .btn-flat{
          background: #593FB7 !important;
          border:  1px solid #593FB7;
    }
  </style>
</head>
...
<div class="login-box">
  <div class="login-logo">
    <a href="{{url('dashboard')}}/index2.html"><img src="{{url('/storage/'.$settings->logo)}}" alt="{{$settings->site_name}}" width="20%"></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
